    ...
    public class BankDetails: TestEngine
    {
        ...
        public void SelectPOLExistingSACC(string loanpurpose)
        {
            if (loanpurpose.Contains(","))
            {
                ...
                {
                    _act.waitForVisibilityOfElement(By.XPath("//div[@id='pol_1']//div[@class='purposeRadioGrp width-50 f-left']//label[contains(text(),'" + loan + "')]"), 500);
            ...
            {
                _act.waitForVisibilityOfElement(By.XPath("//div[@id='pol_1']//div[@class='purposeRadioGrp width-50 f-left']//label[contains(text(),'" + loanpurpose + "')]"), 500);
                IWebElement selectedPOL = _driver.FindElement(By.XPath("//div[@id='pol_1']//div[@class='purposeRadioGrp width-50 f-left']//label[contains(text(),'" + loanpurpose + "')]"));
                string classtextwhenchecked = selectedPOL.GetAttribute("class");
                _act.click1(By.XPath("//div[@id='pol_1']//div[@class='purposeRadioGrp width-50 f-left']//label[contains(text(),'" + loanpurpose + "')]"), "selectpurpose");
        ...
        public void SelectPOLExistingSACC1(string firstloanpurpose, string secondloanpurpose)
        {
            ...
            {
                var Firstpolpurpose = By.XPath("//div[@id='pol_1']//div[@class='purposeRadioGrp width-50 f-left']//label[contains(text(),'" + firstloanpurpose + "')]");
                _act.waitForVisibilityOfElement(Firstpolpurpose, 30);
                _act.click(Firstpolpurpose, "selectpurpose");
                _act.waitForVisibilityOfElement(By.XPath(".//div[@id='pol_2']"), 30);
                _act.click(By.XPath(".//div[@id='pol_2']"), "Second POL");
                var secondpolpurpose = By.XPath("//div[@id='pol_2']//div[@class='purposeRadioGrp width-50 f-left']//label[contains(text(),'" + secondloanpurpose + "')]");
        ...
        /// <param name="firstloanpurpose">first loan POL</param>    
        /// <param name="secondloanpurpose">first loan POL</param> 
        public void SelectPOLExistingSACC(bool pol1, bool pol2, bool pol3, string firstloanpurpose, string secondloanpurpose, string thirdloanpurpose)
        {
            if (pol1)
            {
                //Cash advance
                _act.waitForVisibilityOfElement(By.XPath("//*[@id='ui-id-3']"), 500);
                _act.JSClick(By.XPath("//*[@id='ui-id-3']"), "Money1");
            ...
            {
                //Sunshine
                _act.waitForVisibilityOfElement(By.XPath("//*[@id='ui-id-4']"), 500);
                _act.JSClick(By.XPath("//*[@id='ui-id-4']"), "Money2");
                ...
                if (secondloanpurpose.Contains(","))
                {
                    ...
                    foreach (var loan in purpose)
                    {
                        _act.waitForVisibilityOfElement(By.XPath("//div[@id='pol_2']//div[@class='purposeRadioGrp width-50 f-left']//label[contains(text(),'" + loan + "')]"), 120);
                ...
                else
                {
                    ...
                    if (secondloanpurpose == "Anything else")
                    {
                        _act.EnterText(By.XPath("//*[@class='polMoreDetails']"), "Secret it is");
                    }
                }
            ...
            {
                //Cash train
                _act.waitForVisibilityOfElement(By.XPath("//*[@id='ui-id-5']"), 500);
                _act.JSClick(By.XPath("//*[@id='ui-id-5']"), "Money3");

                if (thirdloanpurpose.Contains(","))
                {
                    var purpose = thirdloanpurpose.Split(',');
                    foreach (var loan in purpose)
                    {
                        _act.waitForVisibilityOfElement(By.XPath("//div[@id='pol_3']//div[@class='purposeRadioGrp width-50 f-left']//label[contains(text(),'" + loan + "')]"), 120);
                        IWebElement selectedPol = _driver.FindElement(By.XPath("//div[@id='pol_3']//div[@class='purposeRadioGrp width-50 f-left']//label[contains(text(),'" + loan + "')]"));
                        string classtextwhenchecked = selectedPol.GetAttribute("class");
                        _act.click1(By.XPath("//div[@id='pol_3']//div[@class='purposeRadioGrp width-50 f-left']//label[contains(text(),'" + loan + "')]"), "selectpurpose");
                    }
                }
                else
                {
                    IWebElement selectedPOL = _driver.FindElement(By.XPath("//div[@id='pol_3']//div[@class='purposeRadioGrp width-50 f-left']//label[contains(text(),'" + thirdloanpurpose + "')]"));
                    string classtextwhenchecked = selectedPOL.GetAttribute("class");
                    _act.click1(By.XPath("//div[@id='pol_3']//div[@class='purposeRadioGrp width-50 f-left']//label[contains(text(),'" + thirdloanpurpose + "')]"), "selectpurpose");

                    if (thirdloanpurpose == "Anything else")
                    {
                        _act.EnterText(By.XPath("//*[@class='polMoreDetails']"), "Secret it is");
                    }
                }
        ...
        {
            _act.waitForVisibilityOfElement(_bankdetailsLoc.ALMErrorMessage, 200);
        ...
        public string getPrefailUpcomingRepaymentFirstPage()
        {
            ...
            //string upcoming1 = a[1];
            //return "$" + upcoming1;
            IWebElement ele = FirstDivideRepayment(By.XPath("//div[@id='divideSection']//div[@class='oauto']"));
        ...
        public string GetPrefailUpcomingRepaymentFirstPageExtend()
        {
        ...
        public IWebElement FirstDivideRepayment(By locator)
        {
            IWebElement ListBox = _driver.FindElement(locator);
            IReadOnlyCollection<IWebElement> options = ListBox.FindElements(By.XPath("//div[@class='reschedule-section f-left width-33']/h3"));
            return options.First();
        }

        public void SelectExpenseSpendCutsOptionBtn()
        {
            _act.waitForVisibilityOfElement(_bankdetailsLoc.SpendCuts, 120);
            _act.JSClick(_bankdetailsLoc.SpendCuts, "expenseDiscretionarySpendingCuts");
        }
    }
}
