...
namespace Nimble.Automation.Repository.Locators
{
    ...
    public class WebSiteRefreshLoanCalculatorLoc
    {
        public static By RePaymentAmount = By.XPath("//div[@id='application-summary-repayments']//span[1]");

        public static By Weekly = By.XPath("//select[@id='application-summary-repayments-freq']//option[contains(text(),'Week')]");

        public static By Fortnightly = By.XPath("//select[@id='application-summary-repayments-freq']");

        public static By Repayment(string Repay)
        {
            return By.XPath("//select[@id='application-summary-repayments-freq']//option[contains(text(),'" + Repay + "')]");
        }
    }
}
