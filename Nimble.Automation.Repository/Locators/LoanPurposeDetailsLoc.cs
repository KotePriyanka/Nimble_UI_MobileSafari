...
namespace Nimble.Automation.Repository.Locators
{
    public interface ILoanPurposeDetails
    {
        ...
        By PersonalDetailsEditDoneBtn { get; }
    ...
    public class LoanPurposeDetailsMobileNLLoc : ILoanPurposeDetails
    {
        ...
        public By EditMyDetailsBtn => By.XPath(".//button[@id='btnEditDetails']");

        public By PersonalDetailsHeader => By.XPath(".//div[@id='mobile-confirmdetails-details']//a[@data-page='personal']");

        public By FirstName => By.XPath(".//input[@id='firstname']");

        public By PersonalDetailsEditDoneBtn => By.XPath(".//button[@id='submit-1']");

        public By BackBtn => By.XPath(".//a[@id='btnback']");
    ...
    public class LoanPurposeDetailsDesktopNLLoc : ILoanPurposeDetails
    {
        ...
        public By MoreInformationContinue => By.XPath("//a[text()='Continue']");
    ...
    public class WebSiteRefreshLoanPurposeLoc
    {
        public static By FirstPOLOtherbutton = By.XPath("//div[@id='primaryPOL']//button");

        public static By SecondaryPOLbutton = By.XPath("//button[@id='secondaryPolBtn']");

        public static By SecondPOLOtherbutton = By.XPath("//div[@id='secondaryPOL']//button");

        public static By SecondPOLbtn = By.XPath("//button[@id='secondaryPolBtn']");

        public static By firstPOL(string POL)
        {
            return By.XPath("//div[@id='primaryPOL']//span[contains(text(),'" + POL + "')]");
        }

        public static By secondPOL(string POL)
        {
            return By.XPath("//div[@id='secondaryPOL']//span[contains(text(),'" + POL + "')]");
        }

        public static By PrimaryOtherPOL(string POL)
        {
            return By.XPath("//div[@id='primarySubList']//div[@class='polcontent']//span[contains(text(),'" + POL + "')]");
        }

        public static By SecondaryOtherPOL(string POL)
        {
            return By.XPath("//div[@id='secondarySubList']//div[@class='polcontent']//span[contains(text(),'" + POL + "')]");
        }

        //SliderMaxBtn 
        public static By SliderMinBtn => By.XPath("//div[@class='display-amount-wrap']//button[@class='slider-minus']");

        //SliderMinBtn
        public static By SliderMaxBtn => By.XPath("//div[@class='display-amount-wrap']//button[@class='slider-plus']");

        public static By MoreInfoContinuebtn => By.XPath(".//div[@id='polMoreInfoButtonWrap']/a[contains(text(),'Continue')]");

        public static By PrimaryPOLdeselected(string POL)
        {
            return By.XPath("//div[@id='primaryPOL']//div[@class='parentpol']//span[contains(text(),'" + POL + "')]");
        }

        public static By PrimarySublistdeselected(string POL)
        {
            return By.XPath("//div[@id='primarySubList']//div[@class='subpol']//span[contains(text(),'" + POL + "')]");
        }

        public static By PrimarySublistselected(string POL)
        {
            return By.XPath("//div[@id='primarySubList']//div[@class='subpol selected']//span[contains(text(),'" + POL + "')]");
        }

        public static By PrimaryPOLSelected(string POL)
        {
            return By.XPath("//div[@id='primaryPOL']//div[@class='parentpol selected']//span[contains(text(),'" + POL + "')]");
        }

        public static By SecondaryPOLdeselected(string POL)
        {
            return By.XPath("//div[@id='secondaryPOL']//div[@class='parentpol']//span[contains(text(),'" + POL + "')]");
        }

        public static By SecondarySublistdeselected(string POL)
        {
            return By.XPath("//div[@id='secondarySubList']//div[@class='subpol']//span[contains(text(),'" + POL + "')]");
        }

        public static By SecondaryPOLSelected(string POL)
        {
            return By.XPath("//div[@id='secondaryPOL']//div[@class='parentpol selected']//span[contains(text(),'" + POL + "')]");
        }

        public static By PrimaryOtherPOLSelected(string POL)
        {
            return By.XPath("//div[@id='primarySubList']//div[@class='subpol selected']//span[contains(text(),'" + POL + "')]");
        }

        public static By SecondPOLRemoveBtn => By.XPath("//button[@id='secondaryPolRemove']");

        public static By SecondarySublistselected(string POL)
        {
            return By.XPath("//div[@id='secondarySubList']//div[@class='subpol selected']//span[contains(text(),'" + POL + "')]");
        }
    }
}
