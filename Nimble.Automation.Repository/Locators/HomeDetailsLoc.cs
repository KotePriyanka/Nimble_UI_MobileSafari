...
namespace Nimble.Automation.Repository.Locators
{
    ...
    public class HomeDetailsMobileNLLoc : IHomeDetails
    {
        ...
        public By ClickForgotPasswordLnk => By.XPath("//a[text()='Forgot Password?']");

        public By EnterForgotPasswordEmailTxt => By.XPath("//*[@id='email']");

        public By ClickForgotPasswordSubmitBtn => By.XPath("//input[@value='Submit']");
    ...
    public class WebSiteRefreshHomeLoc
    {
        public static By WarningButton = By.XPath("//button[@id='warningButton']");

        public static By logo = By.XPath("//img[@src='/content/graphics/images/responsive/logo-basic.png']");

        public static By AmountSliderHandle = By.XPath("//div[@id='apply-slider']/span[@class='ui-slider-handle ui-state-default ui-corner-all']");

        public static By AmountSplitSliderHandle = By.XPath("//div[@id='amount-split-slider']//span");

        public static By ApplicationContinueBtn = By.XPath("//button[@id='application-continue']");

        public static By DurationSliderHandle = By.XPath("//div[@id='term-slider']/span[@class='ui-slider-handle ui-state-default ui-corner-all']");

        public static By DefaultDuration = By.XPath("//div[@id='application-summary-term']//span[1]");

        public static By MinimumDurationSliderValue = By.XPath("//div[@id='calcTerm']//div[@class='minAmount minmax f-left small-label red']");

        public static By MaximumDurationSliderValue = By.XPath("//div[@id='calcTerm']//div[@class='maxAmount minmax f-right small-label red']");

        public static By POLErrorMessage = By.XPath("//div[@id='primaryPOL_error']//p");

        public static By AmountSplitErrorMsg = By.XPath("//div[@id='polAmountSplit_error']//p");

        public static By ProgressBackIcon = By.XPath("//div[@id='application-progress']//button[@id='application-progress-back']");

        public static By CalProgressIcon = By.XPath("//div[@class='calcAmount']//i[1]");

        public static By CalTermProgressIcon = By.XPath("//div[@class='calcAmount calcTerm']//i[2]");

        public static By POLProgressIcon = By.XPath("//div[@class='calcAmount calcTerm polstep1']//i[3]");

        public static By PersonalDetailsProgressIcon = By.XPath("//div[@class='calcAmount calcTerm polstep1 personaldetails']//i[4]");

        public static By PersonalContactProgressIcon = By.XPath("//div[@class='calcAmount calcTerm polstep1 personaldetails contactdetails']//i[5]");

        public static By ConfirmDetailsProgressIcon = By.XPath("//div[@class='calcAmount calcTerm polstep1 personaldetails contactdetails confirmdetails']//i[6]");
